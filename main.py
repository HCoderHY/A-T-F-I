...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(330, 50, 711, 61))
        font = QtGui.QFont()
        font.setFamily("Particle")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(90, 200, 1181, 61))
        font = QtGui.QFont()
        font.setFamily("Particle")
        font.setPointSize(40)
    ...
    def main_func(self):
        ...
        with open(f"C:/Users/user/Desktop/said_text({random.randint(-999999999999999999999999999999999999,999999999999999999999999999999999999)}).txt", "w", encoding="utf-8") as file:
            file.write(text)
        say(text)
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "ATFI 0.0.1"))
        self.label.setText(_translate("MainWindow", "                                                              Audio-text-from-image"))
        self.pushButton.setText(_translate("MainWindow", "Close"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Write link and image..."))
        self.pushButton_2.setText(_translate("MainWindow", "Convert Image to texts and say"))
import sys
